...
my_list = [10, 10.5, "Hello", True, [1, 2], (3, 4), {5, 6}]
...
# 2. Operators
# 4. Check whether a number is a power of 2
...
# 9. Determine the type of triangle
a = int(input("Enter side 1: "))
b = int(input("Enter side 2: "))
c = int(input("Enter side 3: "))
...
# 11. Calculate income tax using tax slabs
# Example:
# ₹0–₹2,50,000 → No tax
# ₹2,50,001–₹5,00,000 → 5%
...
# 12. Menu-driven calculator using if-elif
...
# 14. Find factorial using a loop
...
# 16. Check whether a number is Armstrong
...
# 5. Functions
# 19. Function to check whether a string is palindrome
def palindrome(text):
    if text == text[::-1]:
        return True
    else:
...
# 20. Function to count vowels and consonants
...
# 21. Function to calculate Simple and Compound Interest
...
# 22. Function to return all factors of a number
def factors(num):
...
# 23. Function to find second-largest number
...
# 25. Find second-largest and second-smallest elements
...
# 27. Separate even and odd numbers
...
# 7. Tuples & Sets
# 29. Count frequency of each element in a tuple
...
# 30. Union, intersection and difference of two sets
...
# 33. Create dictionary from two lists


keys = ["name", "age", "city"]
values = ["Kashish", 21, "Nashik"]
...
# 34. Sort dictionary by its values
dict = {
    "A": 50,
    "B": 20,
    "C": 40,
...
# 9. File Handling
# 35. Count lines, words and characters in a file
...
# 36. Copy only even-numbered lines into another file
...
# 37. Handle invalid integer input
